          ...
          <div className="container px-4 md:px-6 grid gap-12 lg:grid-cols-2 lg:gap-24">
            <div className="flex flex-col items-start justify-center space-y-6">
              <div className="space-y-2">
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Meet the Owner</h1>
              ...
              <div className="grid gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-lg">
                    ...
                    <br />
                    <br />
                    Prior to starting this business, Nishnat held various leadership roles at top technology companies, where he
